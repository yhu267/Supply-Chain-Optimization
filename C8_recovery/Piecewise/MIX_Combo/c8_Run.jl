...
println(rp, "Investment Cost (Million \$)", ",", getvalue(tot_invcost))
println(rp, "Transportation Cost (Million \$/yr)", ",",  getvalue(transcost))
println(rp, "Operating Cost (Million \$/yr)", ",", getvalue(tot_oprcost))
println(rp, "Total Annual Cost (Million \$/yr)", ",",  getvalue(totalcost))
...
println("Investment Cost (Million \$) 					: ", getvalue(tot_invcost))
println("Transportation Cost (Million \$/yr) 				: ", getvalue(transcost))
println("Operating Cost (Million \$/yr))  				: ", getvalue(tot_oprcost))
println("Total Annual Cost (Million \$/yr) 				: ", getvalue(totalcost))
