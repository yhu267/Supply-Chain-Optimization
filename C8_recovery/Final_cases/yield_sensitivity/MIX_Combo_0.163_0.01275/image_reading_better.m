...
%f = [f1, f2, f3];
plist = [{'p1'}, {'p2'},{'p3'},{'p4'},{'p5'},{'p6'},{'p7'},{'p8'},{'p9'},{'p10'}];    %list of products
...
h6 = plot(pixel_6x', pixel_6y', 'k', 'LineWidth', 7.5);
...
h7 = plot(pixel_7x', pixel_7y', 'k', 'LineWidth', 7.5);
...
h8 = plot(pixel_8x', pixel_8y', 'k', 'LineWidth', 7.5);
...
h9 = plot(pixel_9x', pixel_9y', 'k', 'LineWidth', 7.5);
...
h10 = plot(pixel_10x', pixel_10y', 'k', 'LineWidth', 7.5);
...
index_1 = find(strcmp(tech_type, 't11')+strcmp(tech_type, 't12')+strcmp(tech_type, 't13')+strcmp(tech_type, 't14')+strcmp(tech_type, 't15'));
index_2 = find(strcmp(tech_type, 't21')+strcmp(tech_type, 't22')+strcmp(tech_type, 't23')+strcmp(tech_type, 't24'));
index_3 = find(strcmp(tech_type, 't31')+strcmp(tech_type, 't32')+strcmp(tech_type, 't33')+strcmp(tech_type, 't34'));
index_4 = find(strcmp(tech_type, 't41')+strcmp(tech_type, 't42')+strcmp(tech_type, 't43')+strcmp(tech_type, 't44')+strcmp(tech_type, 't45'));
index_5 = find(strcmp(tech_type, 't51')+strcmp(tech_type, 't52')+strcmp(tech_type, 't53')+strcmp(tech_type, 't54'));
index_6 = find(strcmp(tech_type, 't61')+strcmp(tech_type, 't62')+strcmp(tech_type, 't63')+strcmp(tech_type, 't64')+strcmp(tech_type, 't65')+strcmp(tech_type,'t91')+strcmp(tech_type, 't92')+strcmp(tech_type, 't93')+strcmp(tech_type, 't94')+strcmp(tech_type, 't95'));
index_7 = find(strcmp(tech_type, 't71')+strcmp(tech_type, 't72')+strcmp(tech_type, 't73')+strcmp(tech_type, 't74')+strcmp(tech_type, 'tA1')+strcmp(tech_type, 'tA2')+strcmp(tech_type, 'tA3')+strcmp(tech_type, 'tA4'));
index_8 = find(strcmp(tech_type, 't81')+strcmp(tech_type, 't82')+strcmp(tech_type, 't83')+strcmp(tech_type, 't84')+strcmp(tech_type, 'tB1')+strcmp(tech_type, 'tB2')+strcmp(tech_type, 'tB3')+strcmp(tech_type, 'tB4'));
index_9 = find(strcmp(tech_type, 'tC1')+strcmp(tech_type, 'tC2')+strcmp(tech_type, 'tC3')+strcmp(tech_type, 'tC4')+strcmp(tech_type, 'tC5'));
index_10 = find(strcmp(tech_type, 'tD1')+strcmp(tech_type, 'tD2')+strcmp(tech_type, 'tD3')+strcmp(tech_type, 'tD4'));
...
for i = 1:length(index_7)
    scatter(lat_plot(index_7(i)), long_plot(index_7(i)),30,[1 0 0], 'filled')
end 

for i = 1:length(index_8)
    scatter(lat_plot(index_8(i)), long_plot(index_8(i)),30,[1 0 0], 'filled')
end 

for i = 1:length(index_9)
    scatter(lat_plot(index_9(i)), long_plot(index_9(i)),30,[1 0 0], 'filled')
end 

for i = 1:length(index_10)
    scatter(lat_plot(index_10(i)), long_plot(index_10(i)),30,[1 0 0], 'filled')
end 
