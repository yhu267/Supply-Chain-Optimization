...
@constraint(m, [n in NODES[271:272], t in [TECHS[1];TECHS[4];TECHS[7]]], y[n,t] == 1);
@constraint(m, [n in NODES[271:272], t in [TECHS[2:3];TECHS[5:6];TECHS[8:9]]], y[n,t] == 0);
@constraint(m, [n in NODES[273:end], t in [TECHS[2:3];TECHS[5:6];TECHS[8:9]]], y[n,t] == 1);
@constraint(m, [n in NODES[273:end], t in [TECHS[1];TECHS[4];TECHS[7]]], y[n,t] == 0); 
