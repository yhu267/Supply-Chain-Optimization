...
for i = 1:length(coeff)
    path = strcat('../../tradeoff_analysis/7_8/', coeff{i});
...
line_color = {[71/255, 155/255, 222/255],[99/255, 203/255, 87/255],[0.95 0.7 0.05],1/255*[255, 54, 133], 1/255*[114, 0, 176], 1/255*[0, 197, 201]};
...
axis([9.3e5/1e6 1.45e6/1e6 0 210 0 100]);
%legend('','Total Cost: 9.31e5 USD', 'Total Cost: 1.17e6 USD','Total Cost: 1.30e6 USD','Total Cost: 1.37e6 USD','Total Cost: 1.40e6 USD','Total Cost: 1.41e6 USD')
XAxisLine = 'off';
x0=10;
y0=10;
